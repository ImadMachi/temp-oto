pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = "fulfillment_frontend"
        COMPOSE_FILE = "/home/ubuntu/apps/oto/fulfillment-frontend/docker-compose.yaml"
        APPROVAL = credentials("APPROVAL_RELEASE")
        AWS_SCRIPT = credentials("AWS_AUTO_START_SCRIPT")
        CONFIG_PROD_AWS = credentials("OTO_FE_PROD_AWS_CONFIG")
    }
    stages {
