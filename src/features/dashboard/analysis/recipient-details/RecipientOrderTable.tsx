...
import getColumns from '../../shipments/common/table-view/Columns'
...
const RecipientOrderTable = ({ data, setData, isLoading, visibleColumns }: OrderListTableProps) => {
  // States
  ...
  const columns = getColumns({ data, setData, locale }).filter(column =>
...
export default RecipientOrderTable
