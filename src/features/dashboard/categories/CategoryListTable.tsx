...
import AddCategoryDialog from './AddProductDialog'
...
interface CategoryListTableProps {
  ...
  isLoading: boolean
  children: {
    bulkAction: () => JSX.Element
    actionMenu: (props: ActionMenuProps) => JSX.Element
  }
}
const CategoryListTable = ({ data, setData, isLoading, children }: CategoryListTableProps) => {
  // Vars
  ...
  const [categoryDialogState, setCategoryDialogState] = useState<'add' | 'edit' | null>(null)
  ...
  return (
    <Card>
      <CardContent className='flex justify-between max-sm:flex-col sm:items-center gap-4'>
        ...
        <div className='flex items-center max-sm:flex-col gap-4 max-sm:is-full is-auto'>
          ...
          <Button
            ...
            onClick={() => setCategoryDialogState('add')}
          >
            Add Category
          </Button>
        </div>
      ...
      <AddCategoryDialog categoryDialogState={categoryDialogState} setCategoryDialogState={setCategoryDialogState} />
    </Card>
  )
}
