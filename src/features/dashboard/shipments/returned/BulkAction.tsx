    ...
    <>
      <div>
        ...
        <Menu keepMounted id='basic-menu' anchorEl={anchorManage} onClose={handleClose} open={Boolean(anchorManage)}>
          ...
          <MenuItem onClick={handleClose}>
            <i className='tabler-edit text-[1rem]' /> Edit Return Reason
          </MenuItem>
          <MenuItem onClick={handleClose}>
            <i className='tabler-check text-[1rem]' /> Confirm Return
          </MenuItem>
          <MenuItem onClick={handleClose}>
            <i className='tabler-list-details text-[1rem]' /> View Return Details
          </MenuItem>
        </Menu>
      </div>
      <div>
        ...
        <Menu keepMounted id='basic-menu' anchorEl={anchorPrint} onClose={handleClose} open={Boolean(anchorPrint)}>
          ...
          <MenuItem onClick={handleClose}>
            <i className='tabler-clipboard-list text-[1rem]' />
