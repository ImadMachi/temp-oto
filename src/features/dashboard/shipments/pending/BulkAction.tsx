  ...
  return (
    <>
      <div>
        ...
        <Menu keepMounted id='basic-menu' anchorEl={anchorManage} onClose={handleClose} open={Boolean(anchorManage)}>
          <MenuItem onClick={handleClose}>
            <i className='tabler-edit text-[1rem]' /> Edit Order
          </MenuItem>
          <MenuItem onClick={handleClose}>
            <i className='tabler-eye text-[1rem]' /> View Order
          </MenuItem>
          <MenuItem onClick={handleClose}>
            <i className='tabler-truck text-[1rem]' /> Reallocate Order
          </MenuItem>
          <MenuItem onClick={handleClose}>
            <i className='tabler-clock text-[1rem]' /> Put On Hold
          </MenuItem>
          <MenuItem onClick={handleClose}>
            <i className='tabler-check text-[1rem]' /> Mark As Delivered
          </MenuItem>
          <MenuItem onClick={handleClose}>
            <i className='tabler-repeat text-[1rem]' /> Synchronize Order
          </MenuItem>
          <MenuItem onClick={handleClose}>
            <i className='tabler-arrows-split text-[1rem]' /> Split Order
          </MenuItem>
          <MenuItem onClick={handleClose}>
      ...
      <div>
        ...
        <Menu keepMounted id='basic-menu' anchorEl={anchorPrint} onClose={handleClose} open={Boolean(anchorPrint)}>
          <MenuItem onClick={handleClose}>
            <i className='tabler-news text-[1rem]' /> Order Details
          </MenuItem>
        </Menu>
      </div>
      <div>
